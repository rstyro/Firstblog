...
<html lang="zh-CN">
	<head>
		...
		<!-- 引入各种CSS样式表 -->
		<link href="<%=root%>/static/bootstrap-3.3.7/css/bootstrap.css" rel="stylesheet">
		<link rel="stylesheet" href="<%=root%>/static/login/font-awesome.css">
		<link rel="stylesheet" href="<%=root%>/static/css/admin.css">	<!-- 修改自Bootstrap官方Demon，你可以按自己的喜好制定CSS样式 -->
		<link rel="stylesheet" href="<%=root%>/static/css/font-change.css">	<!-- 将默认字体从宋体换成微软雅黑（个人比较喜欢微软雅黑，移动端和桌面端显示效果比较接近） -->		
