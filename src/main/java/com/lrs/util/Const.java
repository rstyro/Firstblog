...
public class Const {
	...
	// 下面是SESSION key
	public static final String BLOG_USER_SESSION = "BLOG_USER_SESSION"; // 用户session
																		// key
	public static final String BLOG_LAST_URL = "BLOG_LAST_URL"; // 记录上一个请求的url
																// session Key
	public static final String BLOG_LEAVEWORD_INDEX = "BLOG_LEAVEWORD_INDEX"; // 匿名留言次数限制session
																				// Key
	public static final String BLOG_ARTICLE_PRAISE_INDEX_ = "BLOG_ARTICLE_PRAISE_INDEX_"; // 匿名点赞次数限制session
																							// Key
	public static final String BLOG_COMMENT_PRAISE_INDEX_ = "BLOG_COMMENT_PRAISE_INDEX_"; // 匿名点赞次数限制session
																							// Key
	public static final String BLOG_COMMENT_INDEX = "BLOG_COMMENT_INDEX"; // 匿名评论次数限制session
																			// Key
	public static final String BLOG_ANONYM_USER_SESSION = "BLOG_ANONYM_USER_SESSION"; // 匿名用户session
																						// Key

	public static final String BLOG_REGISTER_INDEX = "BLOG_REGISTER_INDEX"; // ip
																			// 每天注册限制
																			// session
																			// Key
