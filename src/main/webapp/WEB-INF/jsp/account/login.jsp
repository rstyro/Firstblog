		...
		<form class="form-1">
			...
			<div class="login-footer">
				...
				<div class="login-right">
					<a href="https://graph.qq.com/oauth2.0/authorize?response_type=code&client_id=101401237&redirect_uri=http://www.localhost/blog/user/qqredirect&state=lrs_blog" ><img src="<%=root %>/static/images/qq.png"></a>
